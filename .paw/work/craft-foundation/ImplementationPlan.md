...
- [ ] **Phase 1: Project Scaffolding, Core Types & Version Command** — Go module, directory structure, Cobra CLI skeleton, type definitions, working `craft version`
- [ ] **Phase 2: Parsers & Per-Type Validation** — Manifest, pinfile, and frontmatter parsing with individual schema/format validation and comprehensive unit tests (depends on Phase 1)
